...
const deleteProductDB = async (id) => {
  //product folder path
  const folderPath = `test-ecomm/${id}`;
...
module.exports = { getProductInfoDB, getProductsDB, createProductDB, updateProductDB, deleteProductDB, addProductImagesDB, deleteProductImageDB };