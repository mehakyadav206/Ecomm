  ...
  return (
    <div className='flex justify-center items-center h-screen'>
      <form onSubmit={submitHandler} className='rounded w-[260px] border border-gray-300 p-5 shadow-md flex flex-col gap-2'>
        ...
        <InputField value={formState.email} update={setFormState} label="Email" type="email" placeholder="Enter your email" />

        <InputField value={formState.password} update={setFormState} label="Password" type="password" placeholder="Enter your password" />
        
        <button disabled={loading} className='cursor-pointer outline-none bg-blue-500 text-white w-full rounded text-sm py-1 font-semibold disabled:bg-gray-500 disabled:cursor-progress'>
